...
class ReviewController {
  ...
  async handleGetAllReviewsOfUser(req, res) {
    try {
      ...
      const response = await reviewServices.getAllReviewsOfUser({
        userId,
      });
      ...
      return res.status(500).json({
        statusCode: 1,
        message: "Có lỗi xảy ra tại handleGetAllReviewsOfUser",
      });
    }
  }

  async handleGetAllReview(req, res) {
    try {
      const response = await reviewServices.getAllReview();
      ...
      return res.status(500).json({
        statusCode: 1,
        message: "Có lỗi xảy ra tại handleGetAllReview",
      });
    }
  }
